...
public enum CameraType {
  ...
  public final double primaryThetaStandardDeviationCoefficient;
  ...
  private CameraType(
      ...
      double primaryThetaStandardDeviationCoefficient) {
  ...
  private CameraType() {
    ...
    this.primaryThetaStandardDeviationCoefficient = 0.0;
  }
