...
/**
 * An AspectJ aspect that intercepts calls to methods annotated with @Tracer
 * and logs their execution time to AdvantageKit's logger. This is the core
 * of the automatic profiling system.
 */
@Aspect
